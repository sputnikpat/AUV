...
class common():
    ...
    def speed_decreaser(self):
        self.client_conns[esc].sendall(bytes(str(1200) ,'UTF-8'))
    ...
    def run_demo(self):
        ...
        while keep_run:
            ...
            for esc in demo_start_vals:
                if esc == 'ESC1' and hold_othr_escs:
